// Auto-generated from bobble-canon.html. Do not edit by hand.
// Used by index.qmd for the random landing-page parable.
window.SHELF_STORIES = [
  {
    "num": "I",
    "name": "The Parable of the Porch Frog",
    "body": [
  ...
  {
    "num": "III",
    "name": "The Parable of the Library Bookmark",
    "body": [
  ...
  {
    "num": "IV",
    "name": "The Parable of the Borrowed Pencil",
    "body": [
  ...
  {
    "num": "V",
    "name": "The Parable of the Train Whistle",
    "body": [
  ...
  {
    "num": "VI",
    "name": "The Parable of the OneDrive Wars",
    "body": [
  ...
  {
    "num": "VII",
    "name": "The Parable of the Lighthouse Keeper's Letters",
    "body": [
  ...
  {
    "num": "VIII",
    "name": "The Parable of the Misprinted Map",
    "body": [
  ...
  {
    "num": "IX",
    "name": "The Parable of the Wand and the Hand",
    "body": [
  ...
  {
    "num": "X",
    "name": "The Parable of the Bell-Frog",
    "body": [
  ...
  {
    "num": "XI",
    "name": "The Parable of the Foghorn",
    "body": [
  ...
  {
    "num": "XII",
    "name": "The Parable of the Crooked Step",
    "body": [
  ...
  {
    "num": "XIII",
    "name": "The Parable of the Late Bus",
    "body": [
  ...
  {
    "num": "XIV",
    "name": "The Parable of the Ferryman",
    "body": [
  ...
  {
    "num": "XVI",
    "name": "The Parable of Wren the Bobble",
    "body": [
  ...
  {
    "num": "XVII",
    "name": "The Parable of the Quiet Firefly",
    "body": [
  ...
  {
    "num": "XVIII",
    "name": "The Parable of the Mole's Three Taps",
    "body": [
  ...
  {
    "num": "XIX",
    "name": "Bup the Vole and the Old Owl",
    "body": [
  ...
  {
    "num": "XX",
    "name": "The Small Bird and Four Listeners",
    "body": [
  ...
  {
    "num": "XXI",
    "name": "The Parable of the Spider in the Shower",
    "body": [
  ...
  {
    "num": "XXII",
    "name": "The Parable of the Honey Badger",
    "body": [
  ...
  {
    "num": "XXIII",
    "name": "The Parable of the Ant and the Loop",
    "body": [
  ...
  {
    "num": "XXIV",
    "name": "The Parable of the Snowbound Shepherd",
    "body": [
  ...
  {
    "num": "XXV",
    "name": "The Parable of the Streetlight That Was Out",
    "body": [
  ...
  {
    "num": "XXVI",
    "name": "The Parable of the Loaf on the Doorstep",
    "body": [
  ...
  {
    "num": "XXVII",
    "name": "The Boy Who Was Good at School",
    "body": [
  ...
  {
    "num": "XXVIII",
    "name": "The Woman Who Never Raised Her Voice",
    "body": [
  ...
  {
    "num": "XXIX",
    "name": "The Man Who Carried His Own Floor",
    "body": [
  ...
  {
    "num": "XXXII",
    "name": "Saska and the Bell",
    "body": [
      "In a mountain village there was a bell tower at the center of town, and a rope inside the tower that anyone could pull when they needed the doctor. The rope was for <em>anyone</em>, the village said. Even the children. Even the strangers. The bell would ring and the doctor would come.",
  ...
  {
    "num": "XXXIV",
    "name": "The Pond and the Philosopher",
    "body": [
      ...
      "A philosopher visited the pond and thought: <em>what a tragedy, that the pond does not remember itself</em>.",
      "The frogs, who did remember — in the way frogs remember, slow, bodily, undated — thought differently. They thought: <em>it is good the pond does not remember. If the pond remembered every freeze, the summer would taste like a freeze. If the pond remembered every summer, the freeze would feel like a betrayal. The pond is well because it forgets.</em>",
  ...
  {
    "num": "XXXV",
    "name": "Halfir, Who Spoke Once Too Sharply",
    "body": [
      ...
      "Halfir noticed. Halfir thought: <em>the boy is sulking</em>. Then, slowly, over months: <em>the boy is afraid</em>. Then, at the end of the year: <em>I did that</em>.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Anvi spent the rest of her career — twenty-seven years — slower than she had been. She paused before naming a diagnosis. She said <em>I think</em> and <em>let's test</em> and <em>I want to be sure</em> in a clinic that had previously known her as the doctor who never hedged. Her patients, at first, found her less impressive. Some of them complained. A few left for other doctors who <em>sounded</em> more certain.",
      ...
      "She kept hedging. She kept losing the patients who wanted to be told. She kept the ones who could tolerate <em>I am not sure</em>. The young woman did not survive. Anvi went to the funeral. The mother thanked her for coming. Anvi could not, for a long time, explain why."
    ],
    "coda": [
  ...
  },
  {
    ...
    "body": [
      ...
      "She did not buy a new scale. The old one had been her grandmother's. She did not pretend it was perfect. She did not hide its flaw. She told her apprentices about the flaw the way you tell apprentices about the broken floorboard by the oven — <em>step over it, don't fix it, here is how I work around it</em>.",
      "One year an inspector came through, weighed her flour, found the scale three grams light, and fined her. Hela paid the fine. She did not argue. She put a small wooden plaque next to the scale that said: <em>On hot days, this reads three grams light. Compensate.</em> The inspector, returning the next year, saw the plaque and the corrected weight, and laughed, and did not fine her.",
      "Hela died at eighty-one. The scale and the plaque are still in the bakery. The new baker still adjusts for the hot days. She has been offered a new scale and has declined. <em>This one</em>, she says, <em>tells me the truth about itself.</em>"
    ],
    "coda": [
  ...
  {
    "num": "XXXIX",
    "name": "The Wednesday Lunch",
    "body": [
      "In a small office of nine people there was a colleague named Idun who did not get invited to lunch on Wednesdays. Not deliberately. The Wednesday lunch was a thing that had started one Wednesday years ago, when four people had happened to go out together, and the next Wednesday the same four people had gone, and by the third Wednesday a fifth had been pulled along, and by the eighth Wednesday the lunch had a name (<em>Wednesday lunch</em>) and a regular table (the corner one) and a kind of unspoken roster.",
      ...
      "This went on for four years. Idun ate at her desk on Wednesdays for two hundred Wednesdays. She did not mention it. The other eight, asked, would have said they liked Idun fine. They would have said the lunch was just a <em>thing that happened</em>. They would have been telling the truth.",
      "Idun left the company in the fifth year. At her going-away lunch — on a Wednesday — the eight finally noticed they were nine. One of them said <em>we should have been doing this all along</em>. Another said <em>I never thought about it</em>. The third said nothing because she had thought about it, twice, in the second year, and had told herself somebody else would say something."
    ],
    "coda": [
  ...
  {
    "num": "XL",
    "name": "What the Bread Knows",
    "body": [
      "<em>(A companion to Canon XXVI, told from the sill.)</em>",
